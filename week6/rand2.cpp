...
int main() {
  ...
  int num12 = 0;
   ...
   cout << "# of times each score was rolled" << endl;
    ...
    if ((((rand() % 6) + 1)  + ((rand() % 6) + 1)) == 3){
    num3 = num3 + 1;
    }       
     
    if ((((rand() % 6) + 1) + ((rand() % 6) + 1)) == 4){
    num4 = num4 + 1;
    }            
   
    if ((((rand() % 6) + 1) + ((rand() % 6) + 1)) == 5){
    num5 = num5 + 1;
    }            
    
    if ((((rand() % 6) + 1) + ((rand() % 6) + 1)) == 6){
    num6 = num6 + 1;
    }            
    ...
    if ((((rand() % 6) + 1) + ((rand() % 6) + 1)) == 8){
    num8 = num8 + 1;
    }            
        
    if ((((rand() % 6) + 1) + ((rand() % 6) + 1)) == 9){
    num9 = num9 + 1;
    }            
    
    if ((((rand() % 6) + 1) + ((rand() % 6) + 1)) == 10){
    num10 = num10 + 1;
    }            
        
    if ((((rand() % 6) + 1) + ((rand() % 6) + 1)) == 11){
    num11 = num11 + 1;
    }            
    
    if ((((rand() % 6) + 1) + ((rand() % 6) + 1)) == 12){
    num12 = num12 + 1;
    }            
   }
     cout << "2: " << num2 << endl;
